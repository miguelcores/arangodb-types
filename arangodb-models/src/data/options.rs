...
pub const API_PAGINATED_CONTEXT_TYPE: &str = "api_paginated_context_type";
...
pub struct ModelOptions {
    ...
    pub api_paginated_context_type: Option<Ident>,
}
        ...
        for attribute in attributes {
            ...
            match name {
                ...
                API_PAGINATED_CONTEXT_TYPE => {
                    let value = process_string_literal(&meta, name, None)?;
                    result.api_paginated_context_type = Some(format_ident!("{}", value));
                }
